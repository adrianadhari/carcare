...
<body>
      ...
      <div class="flex flex-col w-full rounded-2xl border border-[#E9E8ED] p-4 gap-4 bg-white">
        ...
        <div id="Price-details" class="flex flex-col gap-[10px]">
          <div class="flex items-center justify-between">
            <p class="text-sm leading-[21px]">Service Price</p>
          ...
          <div class="flex items-center justify-between">
            ...
            <p class="font-bold text-xl leading-[30px] text-[#FF8E62]">Rp {{ number_format($grandTotalPrice, 0, ',', '.') }}</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <script src="{{ asset('custom-js/payment.js') }}"></script>
</body>
</html>