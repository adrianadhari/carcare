...
<body>
    <main
        ...
        <div id="Location" class="flex flex-col gap-2 px-4 mt-[30px]">
            ...
            <div class="flex items-center w-full rounded-2xl border border-[#E9E8ED] p-4 gap-[10px] bg-white">
                <div class="w-[80px] h-[60px] flex shrink-0 rounded-xl overflow-hidden">
                    <img src="{{ Storage::url($carStore->thumbnail) }}"
        ...
        <div class="flex h-full flex-1 mt-5">
            <form action="{{ route('front.booking.store', [$carStore->slug, $carService->slug]) }}" method="POST"
                        ...
                        <div class="swiper-wrapper w-full h-fit">
                            <label class="swiper-slide !w-fit group relative">
                                <div
                                    class="rounded-full !w-fit border border-[#E9E8ED] p-[12px_20px] font-semibold transition-all duration-300 hover:bg-[#5B86EF] hover:text-white bg-white group-has-[:checked]:bg-[#5B86EF] group-has-[:checked]:text-white group-has-[:disabled]:bg-[#EEEFF4] group-has-[:disabled]:text-[#AAADBF]">
                                    09:00</div>
                                <input type="radio" name="time_at" id="" value="09:00:00"
                            ...
                            <label class="swiper-slide !w-fit group relative">
                                <div
                                    class="rounded-full !w-fit border border-[#E9E8ED] p-[12px_20px] font-semibold transition-all duration-300 hover:bg-[#5B86EF] hover:text-white bg-white group-has-[:checked]:bg-[#5B86EF] group-has-[:checked]:text-white group-has-[:disabled]:bg-[#EEEFF4] group-has-[:disabled]:text-[#AAADBF]">
                                    10:00</div>
                                <input type="radio" name="time_at" id="" value="10:00:00"
                                    class="absolute top-1/2 left-1/2 -z-10" required>
                            </label>
                            <label class="swiper-slide !w-fit group relative">
                                <div
                                    class="rounded-full !w-fit border border-[#E9E8ED] p-[12px_20px] font-semibold transition-all duration-300 hover:bg-[#5B86EF] hover:text-white bg-white group-has-[:checked]:bg-[#5B86EF] group-has-[:checked]:text-white group-has-[:disabled]:bg-[#EEEFF4] group-has-[:disabled]:text-[#AAADBF]">
                                    11:00</div>
                                <input type="radio" name="time_at" id="" value="11:00:00"
                                    class="absolute top-1/2 left-1/2 -z-10" required>
                            </label>
                            <label class="swiper-slide !w-fit group relative">
                                <div
                                    class="rounded-full !w-fit border border-[#E9E8ED] p-[12px_20px] font-semibold transition-all duration-300 hover:bg-[#5B86EF] hover:text-white bg-white group-has-[:checked]:bg-[#5B86EF] group-has-[:checked]:text-white group-has-[:disabled]:bg-[#EEEFF4] group-has-[:disabled]:text-[#AAADBF]">
                                    12:00</div>
                                <input type="radio" name="time_at" id="" value="12:00:00"
                                    class="absolute top-1/2 left-1/2 -z-10" required>
                            </label>
                            <label class="swiper-slide !w-fit group relative">
                                <div
                                    class="rounded-full !w-fit border border-[#E9E8ED] p-[12px_20px] font-semibold transition-all duration-300 hover:bg-[#5B86EF] hover:text-white bg-white group-has-[:checked]:bg-[#5B86EF] group-has-[:checked]:text-white group-has-[:disabled]:bg-[#EEEFF4] group-has-[:disabled]:text-[#AAADBF]">
                                    13:00</div>
                                <input type="radio" name="time_at" id="" value="13:00:00"
                                    class="absolute top-1/2 left-1/2 -z-10" required>
                            </label>
                            <label class="swiper-slide !w-fit group relative">
                                <div
                                    class="rounded-full !w-fit border border-[#E9E8ED] p-[12px_20px] font-semibold transition-all duration-300 hover:bg-[#5B86EF] hover:text-white bg-white group-has-[:checked]:bg-[#5B86EF] group-has-[:checked]:text-white group-has-[:disabled]:bg-[#EEEFF4] group-has-[:disabled]:text-[#AAADBF]">
                                    14:00</div>
                                <input type="radio" name="time_at" id="" value="14:00:00"
                                    class="absolute top-1/2 left-1/2 -z-10" required>
                            </label>
                            <label class="swiper-slide !w-fit group relative">
                                <div
                                    class="rounded-full !w-fit border border-[#E9E8ED] p-[12px_20px] font-semibold transition-all duration-300 hover:bg-[#5B86EF] hover:text-white bg-white group-has-[:checked]:bg-[#5B86EF] group-has-[:checked]:text-white group-has-[:disabled]:bg-[#EEEFF4] group-has-[:disabled]:text-[#AAADBF]">
                                    15:00</div>
                                <input type="radio" name="time_at" id="" value="15:00:00"
                                    class="absolute top-1/2 left-1/2 -z-10" required>
                            </label>
                            <label class="swiper-slide !w-fit group relative">
                                <div
                                    class="rounded-full !w-fit border border-[#E9E8ED] p-[12px_20px] font-semibold transition-all duration-300 hover:bg-[#5B86EF] hover:text-white bg-white group-has-[:checked]:bg-[#5B86EF] group-has-[:checked]:text-white group-has-[:disabled]:bg-[#EEEFF4] group-has-[:disabled]:text-[#AAADBF]">
                                    16:00</div>
                                <input type="radio" name="time_at" id="" value="16:00:00"
                                    class="absolute top-1/2 left-1/2 -z-10" required>
                            </label>
                        </div>
                    </div>
    ...
    <script src="{{ asset('custom-js/booking.js') }}"></script>
</body>
